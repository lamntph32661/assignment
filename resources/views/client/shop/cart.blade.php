                                        ...
                                        <table class="table">
                                            ...
                                            @endphp
                                                @foreach ($carts as $item)
                                                    <tr><td class="pro-thumbnail"><a href="{{route('Detail',$item->id)}}"><img
                                                                width="600" height="800" src="{{asset($item->image)}}" class="img-fluid"
                                                                alt="Product"></a></td>
                                                    <td class="pro-title"><a href="{{route('Detail',$item->id)}}">{{$item->name}}</a></td>
                                                    <td class="pro-price"><span>${{$item->price}}</span></td>
                                                    <td class="pro-quantity">
                                                        <div class="quantity-selection"><input type="number" value="{{$item->quantity_cart}}"
                                                                min="1"></div>
                                                    </td>
                                                    <td class="pro-subtotal"><span>${{$item->price*$item->quantity_cart}}</span></td>
                                                    <td class="pro-remove"><a href="{{route('DeleteOneCart',$item->cart_id)}}"><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                                @php

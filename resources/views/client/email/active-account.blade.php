<form action="{{ route('Active') }}" method="get" class="registration-form"
    ...
    <p class="greeting" style="font-size: 16px;margin-bottom: 20px;color: #333;">Xin chào {{ $data['name'] }},
        đây là mail xác nhận đăng ký vào Web ABC.cba, sau đây là thông tin đăng ký:</p>
...
{{-- <a href="{{route('Active')}}">kích hoạt</a> --}}

    ...
    <div class="container">
        <div class="padding-top padding-bottom">
            <div class="account-area">
                ...
                <form class="account-form" method="POST" action="{{route('Signup')}}">
                    @csrf
                    <div class="form-group" >
                        <label for="email1">Name<span>*</span></label>
                        <input type="text" name="name" placeholder="Enter Your Name" id="email1" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirmPassword" placeholder="Password" id="pass2" required>
                    </div>
